      ...
      {response ? (
        <div className="mt-8 max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
          ...
          <div className=" my-4 gap-12">
            {pageSpeedResponse ? (
              <div className="grid grid-cols-2 bg-violet-200 rounded-2xl">
                <div>
                  <p className="text-center mx-2">Waktu Untuk Loading Website</p>
                  <p className={`text-4xl ${parseInt(pageSpeedResponse.lighthouseResult.audits["first-contentful-paint"].displayValue) < 3 ? "text-green-600" : "text-red-600"} font-bold  text-center my-4`}>{pageSpeedResponse.lighthouseResult.audits["first-contentful-paint"].displayValue}</p>
                   <p className="text-center text-sm mx-2">idealnya dibawah 3.0s</p>
                </div>
                <div className="flex flex-col m-auto justify-center items-center gap-2">
                  <div
                    className={`radial-progress ${
                      Math.round(
                        pageSpeedResponse.lighthouseResult.categories
                    ...
                    aria-valuenow={
                      pageSpeedResponse.lighthouseResult.categories.performance
                        .score * 100
                    }
                    role="progressbar"
                  >
              ...
              <div>
                ...
                <p className="text-purple-500">
                  Sedang Menentukan Score Website Anda
                </p>
              </div>
            )}
          </div>
